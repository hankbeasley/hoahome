...
namespace HOAHome.Controllers {
    public partial class DevelopmentController {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected DevelopmentController(Dummy d):this() { }
        ...
        public class ViewNames {
            public readonly string Links = "~/Views/Development/Links.aspx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_DevelopmentController: HOAHome.Controllers.DevelopmentController {
        public T4MVC_DevelopmentController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Links() {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Links);
            return callInfo;
        }
